...
def main():
    ...
    # Setup logging
    log_dir = os.path.join(training_args.output_dir, 'record_%s.log' % data_args.task_name)
    ...
    model = AutoModelForSequenceClassification.from_pretrained(
        os.path.join('/home/home/fangchao/tjy/bit/bit_model',data_args.task_name,'pytorch_model.bin'), # model_args.model_name_or_path,
