...
def parse_args() -> Config:
    ...
    setting.add_argument("--bagging", default=2, type=int, help="num of bagging models.")
    setting.add_argument("--boosting", default=2, type=int, help="num of boosting models.")
    setting.add_argument(
        "--max_seq_length",
        default=128,
        type=int,
    ...
    io.add_argument(
        ...
        type=str,
        default=None,
        help="Path to Dataset. Must be provided in `dataset_type` is `online`.",
    )
    io.add_argument(
        "--output_dir",
        type=Path,
